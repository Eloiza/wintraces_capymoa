...
df = pd.read_csv("gatilhos_skmultiflow.csv")
# df2 = pd.read_csv("gatilhos_river.csv")
# df3 = pd.read_csv("gatilhos_capymoa.csv")
...
for key, color in zip(["drift_skmultiflow"], ["orange", "blue", "black"]):    
...
custom_lines = []
custom_lines.append(Line2D([0], [0], linestyle='--',color= "orange", label="skmultiflow - batata"))
...
# plt.legend()
plt.title("Triggers - skmultiflow")
plt.show()